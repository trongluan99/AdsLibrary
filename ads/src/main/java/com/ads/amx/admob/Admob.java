...
import com.ads.amx.dialog.PrepareLoadingAdsDialog;
import com.ads.amx.event.AmxLogEventManager;
import com.ads.amx.funtion.AdCallback;
import com.ads.amx.funtion.AdType;
import com.ads.amx.funtion.AdmobHelper;
import com.ads.amx.funtion.RewardCallback;
...
public class Admob {
    private static final String TAG = "AmxStudio";
    ...
    public void onShowSplashHighFloorOrAll(AppCompatActivity activity, AdCallback adListener) {
        ...
        mInterstitialSplash.setOnPaidEventListener(adValue -> {
            ...
            AmxLogEventManager.logPaidAdImpression(context,
                    adValue,
            ...
            if (tokenAdjust != null) {
                AmxLogEventManager.logPaidAdjustWithToken(adValue, mInterstitialSplash.getAdUnitId(), tokenAdjust);
            }
        });
        ...
        mInterstitialSplash.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                AmxLogEventManager.logClickAdsEvent(context, mInterstitialSplash.getAdUnitId());
            }
            ...
            public void onInterstitialLoad(InterstitialAd interstitialAd) {
                ...
                if (interstitialAd != null) {
                    interstitialAd.setOnPaidEventListener(adValue -> {
                        ...
                        if (tokenAdjust != null) {
                            AmxLogEventManager.logPaidAdjustWithToken(adValue, interstitialAd.getAdUnitId(), tokenAdjust);
                        }
                    });
                }
            }
    ...
    public void showInterstitialAdByTimes(final Context context, InterstitialAd mInterstitialAd, final AdCallback callback) {
        ...
        mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                AmxLogEventManager.logClickAdsEvent(context, mInterstitialAd.getAdUnitId());
            }
        });
        ...
        try {
            ...
            adView.setAdListener(new AdListener() {
                ...
                public void onAdLoaded() {
                    ...
                    if (adView != null) {
                        adView.setOnPaidEventListener(adValue -> {
                            ...
                            if (tokenAdjust != null) {
                                AmxLogEventManager.logPaidAdjustWithToken(adValue, adView.getAdUnitId(), tokenAdjust);
                            }
                        });
                    }
                ...
                public void onAdClicked() {
                    ...
                    AmxLogEventManager.logClickAdsEvent(context, id);
                }
    ...
    private void loadInlineAdaptiveBanner(final Activity mActivity, String id, AdCallback adCallback) {
        AdSize adSize = AdSize.getCurrentOrientationInlineAdaptiveBannerAdSize(mActivity, 320);
                ...
                .forNativeAd(new NativeAd.OnNativeAdLoadedListener() {
                    ...
                    public void onNativeAdLoaded(@NonNull NativeAd nativeAd) {
                        ...
                        nativeAd.setOnPaidEventListener(adValue -> {
                            Log.d(TAG, "OnPaidEvent NativeAd:" + adValue.getValueMicros());
                            ...
                            if (tokenAdjust != null) {
                                AmxLogEventManager.logPaidAdjustWithToken(adValue, id, tokenAdjust);
                            }
                        });
                    }
                })
            ...
            public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
                ...
                Admob.this.rewardedAd.setOnPaidEventListener(adValue -> {
                    ...
                    AmxLogEventManager.logPaidAdImpression(context,
                            ...
                            , AdType.REWARDED);
                    if (tokenAdjust != null) {
                        AmxLogEventManager.logPaidAdjustWithToken(adValue, rewardedAd.getAdUnitId(), tokenAdjust);
                    }
                });
            }
        ...
        if (rewardedAd == null) {
            ...
            Admob.this.rewardedAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                ...
                public void onAdClicked() {
                    ...
                    if (disableAdResumeWhenClickAds)
                        AppOpenManager.getInstance().disableAdResumeByClickAction();
                    AmxLogEventManager.logClickAdsEvent(context, rewardedAd.getAdUnitId());
                }
            });
    ...
    public void showRewardInterstitial(final Activity activity, RewardedInterstitialAd rewardedInterstitialAd, final RewardCallback adCallback) {
        ...
        if (rewardedInterstitialAd == null) {
            ...
            rewardedInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                ...
                public void onAdClicked() {
                    super.onAdClicked();
                    AmxLogEventManager.logClickAdsEvent(activity, rewardedAd.getAdUnitId());
                    if (disableAdResumeWhenClickAds)
                        AppOpenManager.getInstance().disableAdResumeByClickAction();
                }
            });
