...
public class AppLovin {
    ...
    public void init(Context context, AppLovinCallback adCallback, String tokenAdjust) {
    ...
    public void init(Context context, AppLovinCallback adCallback, Boolean enableDebug, String tokenAdjust) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            String processName = Application.getProcessName();
            String packageName = context.getPackageName();
            if (!packageName.equals(processName)) {
    ...
    public void loadSplashInterstitialAds(final Context context, String id, long timeOut, long timeDelay, AppLovinCallback adListener) {
        ...
        interstitialSplash.setListener(new MaxAdListener() {
            ...
            public void onAdClicked(MaxAd ad) {
                ...
                AmxLogEventManager.logClickAdsEvent(context, ad.getAdUnitId());
            }
    ...
    public void onShowSplash(Activity activity, AppLovinCallback adListener) {
        ...
        interstitialSplash.setRevenueListener(ad -> {
            AmxLogEventManager.logPaidAdImpression(context, ad, AdType.INTERSTITIAL);
            if (tokenAdjust != null) {
        ...
        interstitialSplash.setListener(new MaxAdListener() {
            ...
            @Override
            public void onAdClicked(MaxAd ad) {
                AmxLogEventManager.logClickAdsEvent(context, interstitialSplash.getAdUnitId());
                if (adListener != null) {
                    adListener.onAdClicked();
                }
                if (disableAdResumeWhenClickAds)
    ...
    private void loadBanner(final Activity mActivity, String id, final FrameLayout adContainer, final ShimmerFrameLayout containerShimmer) {
        ...
        adView.setRevenueListener(ad -> {
            AmxLogEventManager.logPaidAdImpression(mActivity, ad, AdType.BANNER);
            if (tokenAdjust != null) {
                AmxLogEventManager.logPaidAdjustWithTokenMax(ad, ad.getAdUnitId(), tokenAdjust);
            }
        });
    ...
    public MaxRecyclerAdapter getNativeRepeatAdapter(Activity activity, String id, int layoutCustomNative, RecyclerView.Adapter originalAdapter,
        ...
        MaxNativeAdViewBinder binder = new MaxNativeAdViewBinder.Builder(layoutCustomNative)
                .setTitleTextViewId(com.ads.amx.R.id.ad_headline)
                .setBodyTextViewId(com.ads.amx.R.id.ad_body)
                .setAdvertiserTextViewId(com.ads.amx.R.id.ad_advertiser)
                .setIconImageViewId(com.ads.amx.R.id.ad_app_icon)
                .setMediaContentViewGroupId(com.ads.amx.R.id.ad_media)
                .setOptionsContentViewGroupId(com.ads.amx.R.id.ad_options_view)
                .setCallToActionButtonId(com.ads.amx.R.id.ad_call_to_action)
                .build();
    ...
    public void showRewardAd(Activity activity, MaxRewardedAd maxRewardedAd, AppLovinCallback callback) {
        if (maxRewardedAd.isReady()) {
            maxRewardedAd.setRevenueListener(ad -> {
                AmxLogEventManager.logPaidAdImpression(activity, ad, AdType.REWARDED);
                if (tokenAdjust != null) {
                    AmxLogEventManager.logPaidAdjustWithTokenMax(ad, ad.getAdUnitId(), tokenAdjust);
                }
            });
