...
import com.ads.amx.ads.AmxAdCallback;
...
public class AppOpenMax implements Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    private AmxAdCallback amxAdCallback;
    ...
    public void loadAdResumeMax(Application application, String appOpenAdId) {
        ...
        appOpenAd.setListener(new MaxAdListener() {
            ...
            public void onAdLoaded(MaxAd ad) {
                ...
                if (amxAdCallback != null) {
                    amxAdCallback.onAdLoaded();
                }
            }
            ...
            public void onAdLoadFailed(String adUnitId, MaxError error) {
                ...
                dismissDialogLoading();
                if (amxAdCallback != null) {
                    amxAdCallback.onAdFailedToLoad(new ApAdError(error));
                }
            }
            ...
            public void onAdDisplayFailed(MaxAd ad, MaxError error) {
                ...
                dismissDialogLoading();
                if (amxAdCallback != null) {
                    amxAdCallback.onAdFailedToShow(new ApAdError(error));
                }
            }
        });
        appOpenAd.loadAd();
    ...
    public void setAppOpenMaxCallback(AmxAdCallback amxAdCallback) {
        this.amxAdCallback = amxAdCallback;
    }
        ...
        if (openAdSplash.isReady()) {
            ...
            openAdSplash.setRevenueListener(new MaxAdRevenueListener() {
                ...
                public void onAdRevenuePaid(MaxAd maxAd) {
                    AmxLogEventManager.logPaidAdImpression(context, maxAd, AdType.APP_OPEN);
                    AmxLogEventManager.logPaidAdjustWithTokenMax(maxAd, maxAd.getAdUnitId(), AmxAdConfig.ADJUST_TOKEN_TIKTOK);
                }
            });
            openAdSplash.showAd();
        } else {
