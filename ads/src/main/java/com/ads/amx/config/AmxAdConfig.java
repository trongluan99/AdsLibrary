...
public class AmxAdConfig {
    ...
    public AmxAdConfig(Application application) {
        this.application = application;
    }

    public AmxAdConfig(Application application, String environment) {
