...
public class AmxAppsflyer {
    private static final String TAG = "AmxAppsflyer";
    private Context context;
    private static AmxAppsflyer amxAppsflyer;
    public static boolean enableAppsflyer = false;

    public AmxAppsflyer() {
    }

    public static AmxAppsflyer getInstance(){
        if (amxAppsflyer ==null)
            amxAppsflyer = new AmxAppsflyer();
        return amxAppsflyer;
    }
